  ...
  const loadSchedule = async (professionalId: number) => {
    try {
      ...
      if (schedule) {
        ...
        const generatedEvents = generateEventsFromSchedule(
          grouped,
          sessionTime
        );
        setScheduleEvents([]);
        ...
        onSelectEvent={(event) => {
          ...
          if (
            ...
            const appointmentInput = {
              ...
              specialty: "Especialidad X", // reemplazar si tenés info real
            ...
            setPaymentLink(null); // limpiamos si no es evento libre
          }
        }}
        date={date}
